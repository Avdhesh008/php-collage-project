  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <form method="POST" action="{{ route('admin.login') }}">
        ...
        <div class="error"><p id="error_email_login"><p></div>
        ...
        <div class="error"><p id="error_password_login"><p></div>
...
$("#admin-login").on('submit',(function(ddds){
...
{ 
    ...
    if(data.validation_errors)
   {
    ...
    if(data.status==400)
    {
      //$("#error_password_login").html(data.message);
