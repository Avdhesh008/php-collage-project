          ...
          <div class="row my_uired_kl">
            ...
            <div class="col-md-6">
              <div class="formrow">
                ...
                <input type="text" name="client_mobile" value="" class="form-control" placeholder="Phone" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="formrow">
                <label>Client Address</label>
                <textarea name="client_address" class="form-control" placeholder="Client Address" required></textarea>
              </div>
            </div>
            <div class="col-md-12">
              <div class="formrow">
