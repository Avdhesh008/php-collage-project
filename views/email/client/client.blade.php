        ...
        <table class="table table-bordered">
            ...
            <tbody id='sdfsdfdsfs'>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{url('email/delete-client',['id'=>encrypt($val->id)])}}" method="POST" id="delete_client">
                            @csrf
                            <a href="javascript:void(0);" onclick="submitForm()"><button class="btn btn-danger">Delete</button></a>
                        </form>
                        <!-- <a href="{{url('email/edit_client/'.$val->id)}}"><button type="submit" class="btn btn-info">Edit</button></a> -->
                    </td>
                </tr>
