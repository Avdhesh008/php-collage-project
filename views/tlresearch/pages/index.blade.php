    ...
    <div class='umesh_tab'>
        <form action="{{url('tlresearch/assign-check')}}" method="POST">
            ...
            <div class="selecttt">
                ...
                <div class="formrow">
                    <select class="form-control" name="assign_to_research">
        ...
        <table class="table table-bordered">
            ...
            <tbody id='sdfsdfdsfs'>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{url('tlresearch/assign/'.$val->id)}}"><button type="submit" class="btn btn-info">Assign</button></a>
                    </td>
                </tr>
